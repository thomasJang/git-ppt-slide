...
const slides: Slide[] = [
  ...
  },
  {
    ...
    title: "Git 저장소(Repository)란?",
    message: "Repository는 프로젝트의 모든 변경 이력을 저장하는 공간이다.",
    content:
      "Git 저장소는 단순히 파일을 보관하는 폴더가 아닙니다.\n\n프로젝트의 현재 상태뿐 아니라 과거 상태까지 모두 기록합니다.\n\nRepository 안에는 Commit 이력, Branch 정보, 태그 정보, 변경 기록이 저장됩니다. Repository 덕분에 우리는 언제든 과거 상태를 확인하거나 복구할 수 있습니다.",
    example: "Repository\n\n├─ Commit A\n├─ Commit B\n├─ Commit C\n└─ Commit D",
    note: "Git은 파일 관리 도구가 아니라 역사 관리 도구라고 설명.",
  },
  {
    eyebrow: "02 Git Basic",
    title: "첫 저장소 만들기",
    message: "모든 Git 프로젝트는 git init으로 시작한다.",
    content:
      "새로운 Todo App 프로젝트를 만들어 보겠습니다.\n\n터미널에서 폴더를 만들고, 그 폴더로 이동한 뒤 git init을 실행합니다.\n\ngit init은 현재 폴더를 Git 저장소로 변환합니다. 실행 후 .git 폴더가 생성됩니다.",
    example: "mkdir todo-app\ncd todo-app\ngit init\n\n# output\nInitialized empty Git repository",
    note: "오늘 모든 실습은 Todo App 기준으로 진행.",
  },
  {
    eyebrow: "02 Git Basic",
    title: ".git 폴더는 무엇일까?",
    message: "Git의 모든 데이터는 .git 안에 저장된다.",
    content:
      ".git 폴더는 Git의 데이터베이스입니다.\n\n안에는 objects, refs, config, HEAD 등이 존재합니다.\n\n이 폴더를 삭제하면 Git 이력이 모두 사라집니다. 일반 프로젝트 파일과 Git의 이력 데이터가 분리되어 있다는 점을 이해하는 것이 중요합니다.",
    example: ".git\n\n├─ objects\n├─ refs\n├─ HEAD\n└─ config",
    note: ".git 폴더를 직접 열어 보되 수정하거나 삭제하지 않게 안내한다.",
  },
  {
    eyebrow: "02 Git Basic",
    title: "Git 상태 확인하기",
    message: "Git 사용자는 항상 상태를 확인해야 한다.",
    content:
      "가장 많이 사용하는 명령어입니다.\n\ngit status는 현재 작업 상태를 보여줍니다.\n\nUntracked, Modified, Staged 상태를 이해하는 것이 중요합니다. Git을 쓰다가 헷갈리면 가장 먼저 status를 확인해야 합니다.",
    example: "git status",
    note: "실습 중 막히면 git status부터 보게 만든다.",
  },
  {
    eyebrow: "02 Git Basic",
    title: "README 만들기",
    message: "Git은 새로운 파일을 자동으로 관리하지 않는다.",
    content:
      "README.md 파일을 만들어 봅니다.\n\n파일 생성 후 git status를 실행하면 Untracked 상태가 나타납니다.\n\nGit은 새 파일이 생긴 것을 알아차리지만, 아직 이 파일을 기록 대상으로 확정하지는 않습니다.",
    example: "echo \"# Todo App\" > README.md\n\ngit status\n\nUntracked files:\nREADME.md",
    note: "새 파일은 Git이 바로 추적하지 않는다는 점을 보여준다.",
  },
  {
    eyebrow: "02 Git Basic",
    ...
    message: "현재 작업중인 공간",
    content:
      "파일을 수정하면 Working Directory 상태가 됩니다.\n\n아직 Git은 변경 내용을 저장하지 않았습니다.\n\n그저 파일이 변경되었다는 사실만 알고 있습니다. 우리가 코드를 작성하고 수정하는 실제 프로젝트 폴더가 Working Directory입니다.",
    example: "README.md\n\nModified",
    note: "작업 공간과 Git 기록은 별개라는 점을 강조한다.",
  },
  {
    eyebrow: "02 Git Basic",
    title: "Staging Area",
    message: "Commit 전에 검토하는 공간",
    content:
      "Git은 바로 Commit 하지 않습니다.\n\n먼저 Stage에 올립니다.\n\nStaging Area는 Commit에 포함할 변경을 검토하고 선택하는 공간입니다. 여러 변경 중 하나만 골라 Commit할 수 있기 때문에 작은 단위의 기록을 만들 수 있습니다.",
    example: "git add README.md\n\nWorking Directory\n      ↓\n Staging Area",
    note: "학생들이 가장 어려워하는 개념. 장바구니 비유가 효과적이다.",
  },
  {
    eyebrow: "02 Git Basic",
    title: "git add",
    message: "Commit 대상을 선택하는 명령",
    content:
      "git add README.md 또는 git add .을 사용할 수 있습니다.\n\nStage에 등록된 파일만 Commit 됩니다.\n\nadd는 저장이 아닙니다. Commit 후보로 올리는 과정입니다. 실무에서는 의도에 맞는 파일만 선택해 add하는 습관이 중요합니다.",
    example: "git add README.md\n\ngit add .\n\nREADME.md\n\nReady to Commit",
    note: "add는 Commit 대상 선택이라고 표현한다.",
  },
  {
    eyebrow: "02 Git Basic",
    title: "Commit",
    message: "Commit은 프로젝트 스냅샷이다.",
    content:
      "git commit -m 명령으로 현재 상태를 기록합니다.\n\nCommit은 저장이 아니라 역사 생성입니다.\n\nCommit에는 변경 내용, 메시지, 작성자, 시간, 이전 Commit과의 연결 정보가 남습니다. 나중에 프로젝트 흐름을 이해하는 핵심 단위입니다.",
    example: "git commit -m \"docs: add README\"\n\nCommit A",
    note: "Commit은 Ctrl+S가 아니라 설명이 붙은 역사 기록이라고 강조한다.",
  },
  {
    eyebrow: "02 Git Basic",
    title: "좋은 Commit 메시지",
    message: "Commit 메시지는 미래의 나를 위한 문서다.",
    content:
      "좋은 Commit 메시지는 변경 의도를 설명합니다.\n\n좋은 예는 feat: add login page, fix: resolve login error, docs: update README처럼 변경 종류와 목적이 드러납니다.\n\n나쁜 예는 수정, 최종, ㅋㅋ처럼 나중에 봐도 의미를 알 수 없는 메시지입니다.",
    example: "feat: add login page\nfix: resolve login error\ndocs: update README\n\n# types\nfeat\nfix\ndocs\nrefactor",
    note: "처음부터 완벽할 필요는 없지만 동사와 목적이 보이게 쓰도록 지도한다.",
  },
  {
    eyebrow: "02 Git Basic",
    title: "Todo App 기능 추가",
    message: "기능 단위로 Commit 한다.",
    content:
      "Todo App을 기능 단위로 나누어 Commit합니다.\n\nCommit 1은 README 생성, Commit 2는 Todo 목록 추가, Commit 3은 Todo 등록 기능, Commit 4는 Todo 삭제 기능입니다.\n\n이렇게 나누면 앱이 어떻게 성장했는지 기록으로 확인할 수 있습니다.",
    example: "Commit 1: README 생성\nCommit 2: Todo 목록 추가\nCommit 3: Todo 등록 기능\nCommit 4: Todo 삭제 기능\n\nA → B → C → D",
    note: "결과물보다 Commit을 나누는 사고방식에 집중하게 한다.",
  },
  {
    eyebrow: "02 Git Basic",
    title: "Git Log",
    message: "Git은 모든 역사를 기억한다.",
    content:
      "git log는 Commit 이력을 확인하는 명령입니다.\n\n기본 log, 한 줄로 보는 --oneline, 그래프 형태로 보는 --graph를 사용할 수 있습니다.\n\nLog를 읽을 수 있어야 프로젝트가 어떤 순서로 바뀌었는지 이해할 수 있습니다.",
    example: "git log\n\ngit log --oneline\n\ngit log --graph\n\n* D\n* C\n* B\n* A",
    note: "학생들이 자신이 만든 Todo App Commit 흐름을 직접 읽어보게 한다.",
  },
  {
    eyebrow: "02 Git Basic",
    title: "이전 상태 보기",
    message: "Git은 시간 여행이 가능하다.",
    content:
      "git show는 Commit의 상세 내용을 보여줍니다.\n\ngit checkout commit-id를 사용하면 과거 상태를 확인할 수 있습니다.\n\n단, 과거 상태에서 새 작업을 시작하면 혼란이 생길 수 있으므로 처음에는 보기 용도로 사용합니다.",
    example: "git show\n\ngit checkout commit-id\n\nToday\n ↓\nYesterday\n ↓\nLast Week",
    note: "과거 상태를 보는 것과 현재 작업을 이어가는 것을 구분해 설명한다.",
  },
  {
    eyebrow: "02 Git Basic",
    title: "수정 취소",
    message: "실수는 복구할 수 있다.",
    content:
      "git restore . 명령은 Commit 하지 않은 변경을 취소합니다.\n\nWorking Directory의 변경을 마지막 Commit 상태로 되돌립니다.\n\n강력한 명령이므로 실행하기 전에는 git status로 어떤 변경이 사라질지 확인해야 합니다.",
    example: "git restore .\n\nModified\n\n ↓\n\nOriginal",
    note: "복구 명령은 편리하지만 변경 내용이 사라질 수 있음을 반드시 알려준다.",
  },
  {
    eyebrow: "02 Git Basic",
    title: "Git Basic 정리",
    message: "Git의 핵심 흐름을 이해하자.",
    content:
      "git init, git status, git add, git commit, git log.\n\n이 다섯 개만 이해해도 Git의 절반은 이해한 것입니다.\n\nCreate, Modify, Add, Commit, Log의 흐름을 반복하며 Git의 기본 동작을 몸에 익히는 것이 목표입니다.",
    example: "git init\ngit status\ngit add\ngit commit\ngit log\n\nCreate\n ↓\nModify\n ↓\nAdd\n ↓\nCommit\n ↓\nLog",
    note: "명령어를 순서가 있는 흐름으로 정리한다.",
  },
  {
